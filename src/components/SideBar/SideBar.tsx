...
export default function SideBar(props) {
  ...
  //  - dietChoices, setDietChoices, selected, setSelected, ingredientChoices, setIngredientChoices, showRed, createCards, standardSearch, setStandardSearch, getApiData
      ...
      >
        ...
        <Offcanvas.Body className="filter-body">
          ...
          <SideBarSection
            ...
            setMealChoice={props.setMealChoice}
            cuisineChoices={props.cuisineChoices}
            setCuisineChoices={props.setCuisineChoices}
            intoleranceChoices={props.intoleranceChoices}
            setIntoleranceChoices={props.setIntoleranceChoices}
            dietChoices={props.dietChoices}
            setDietChoices={props.setDietChoices}
